...
export const LOWER_LEFT_STORY_ZONE_DIALOGUE: InteractionDialogueScript = {
  characterDelaySeconds: 0.02,
  speakers: ["Sbaak"],
  lines: [{ speaker: "Sbaak", text: "現在我還沒準備好。" }],
};
